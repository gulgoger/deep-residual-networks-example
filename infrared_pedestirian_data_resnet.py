...
TRAIN_BASE_PATH = r"C:/Users/asus_/python_programlama/Deep Learning2/deep_residual_networks/LSIFIR/Classification/Train"

# read train negative
train_negative_path = TRAIN_BASE_PATH +"/neg"
...
train_positive_path = TRAIN_BASE_PATH +"/pos"
...
TRAIN_BASE_TEST_PATH = r"C:/Users/asus_/python_programlama/Deep Learning2/deep_residual_networks/LSIFIR/Classification/Test"

# read test negative - 22050
test_negative_path = TRAIN_BASE_TEST_PATH + "/neg"
...
test_positive_path = TRAIN_BASE_TEST_PATH+ "/pos"
...
y_test_positive_tensor = torch.zeros(10000, dtype = torch.long)
...
#%%
test = torch.utils.data.TensorDataset(x_test,y_test[:24000])
testloader = torch.utils.data.DataLoader(test[0],batch_size=batch_size, shuffle = False)
...
# model = ResNet(BasicBlock, [2,2,2]).to(device)   -- cpu
